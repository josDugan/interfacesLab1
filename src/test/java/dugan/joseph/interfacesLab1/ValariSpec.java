 ...
 */
public class ValariSpec {

    private final static int FUEl_UNIT = 100;
    private final static int DISTANCE = 5;
    private final static Car.FuelType SOLAR = Car.FuelType.SOLAR;
    ...
    @Test
    public void givenThatValariIsContructedWithFuelTypeGASCarHasFuelTypeGAS() {
        Car.FuelType expected = SOLAR;
