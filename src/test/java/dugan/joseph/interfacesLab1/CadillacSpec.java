 ...
 */
public class CadillacSpec {
    private final static int FUEl_UNIT = 100;
    private final static int DISTANCE = 5;
    private final static Car.FuelType ELECTRICITY = Car.FuelType.ELECTRICITY;


    private Cadillac car;
    ...
    @Test
    public void givenThatCadillacIsContructedWithFuelTypeGASCarHasFuelTypeGAS() {
        Car.FuelType expected = ELECTRICITY;
